...
async function exportPictureReport(): Promise<void> {
  ...
  const lines = [
    ...
    `totalPixels: ${pictureStatistics.value.totalPixels}`,
    `differentPixels: ${pictureStatistics.value.differentPixels}`,
    `differenceRatio: ${pictureStatistics.value.differenceRatio}`,
